...
void Lora_Init(LoRa *pL, SPI_HandleTypeDef *phspi, uint16_t frequency){
	pL->hSPIx                 = phspi;
	pL->CS_port               = NSS_GPIO_Port;
	pL->CS_pin                = NSS_Pin;
	pL->reset_port            = RESET_GPIO_Port;
	pL->reset_pin             = RESET_Pin;
	pL->DIO0_port						 = DIO0_GPIO_Port;
	pL->DIO0_pin							 = DIO0_Pin;
