...
#define DIO0_RX_Pin GPIO_PIN_10
#define DIO0_RX_GPIO_Port GPIOB
#define DIO0_RX_EXTI_IRQn EXTI15_10_IRQn
#define RESET_TX_Pin GPIO_PIN_11
#define RESET_TX_GPIO_Port GPIOB
#define NSS_TX_Pin GPIO_PIN_12
#define NSS_TX_GPIO_Port GPIOB
#define NSS_RX_Pin GPIO_PIN_8
#define NSS_RX_GPIO_Port GPIOA
#define RESET_RX_Pin GPIO_PIN_11
